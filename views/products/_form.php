    ...
    <div class="card card-primary">
        ...
        <div class="dinamic-form">
            ...
            <div class="default-panel" data-id="10" data-page="products">
                ...
                <div class="form-group col-md-12 col-lg-12 col-sm-12 productsproducts">
                    <?= $form->field($model, 'warehouse_id')->dropDownList($warehouse,['required' => true]) ?>
                </div>
                <div class="form-group col-md-12 col-lg-12 col-sm-12 productsNomenclature">
                    <?= $form->field($model, 'nomenclature_id')->dropDownList($nomenclature, ['required' => true,]) ?>
                </div>
                <div class="form-group col-md-12 col-lg-12 col-sm-12 productsCount">
                    <?= $form->field($model, 'count')->input('number',['required' => true]) ?>
                </div>
