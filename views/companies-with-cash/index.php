...
/** @var app\models\CompaniesWithCashSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */
$this->params['sub_page'] = $sub_page;
$this->params['date_tab'] = $date_tab;
$this->title = 'Կանխիկ միջոցներով ընկերություններ';
$this->params['breadcrumbs'][] = $this->title;
$have_access_create = Users::checkPremission(82);
$have_access_update = Users::checkPremission(83);
$have_access_delete = Users::checkPremission(84);
$action_column = [];
$access_buttons = '';
...
if (!empty($access_buttons)) {
    $action_column[] = [
        ...
        'urlCreator' => function ($action, CompaniesWithCash $model, $key, $index, $column) {
            return Url::toRoute([$action, 'id' => $model->id]);
        }
    ];
}
?>
<div class="companies-with-cash-index">
    ...
    <p>
        <?php if($have_access_create){ ?>
            <?= Html::a('Ստեղծել ընկերություն', ['create'], ['class' => 'btn rounded-pill btn-secondary']) ?>
        <?php } ?>
    </p>
