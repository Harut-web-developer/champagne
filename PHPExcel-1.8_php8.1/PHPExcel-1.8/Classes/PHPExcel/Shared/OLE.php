...
* @var  array
*/
use app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExcel$GLOBALS['_OLE_INSTANCES'] = array();
...
class PHPExcel_Shared_OLE
{
    ...
    */
    public function getStream($blockIdOrPps)
    {
        ...
        if (!$isRegistered) {
            stream_wrapper_register('ole-chainedblockstream', 'app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Shared\OLE\PHPExcel_Shared_OLE_ChainedBlockStream');
            $isRegistered = true;
        }
