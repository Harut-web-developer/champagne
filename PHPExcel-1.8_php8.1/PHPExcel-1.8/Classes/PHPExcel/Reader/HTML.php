...
use app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExcelif (!defined('PHPEXCEL_ROOT')) {
    /**
     * @ignore
     */
...
//                        }
                        ...
                        if (isset($attributeArray['rowspan']) && isset($attributeArray['colspan'])) {
                            ...
                            foreach (\Classes\PHPExcel\PHPExcel_Cell::extractAllCellReferencesInRange($range) as $value) {
