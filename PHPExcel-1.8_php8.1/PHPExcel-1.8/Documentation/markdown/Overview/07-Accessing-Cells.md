...
use app\PHPExceluse app\PHPExcel$dateTimeNow = time();
...
use app\PHPExcel$objPHPExcel->getActiveSheet()->setCellValueExplicit(
    'A8', 
    "01513789642",
...
```php
use app\PHPExceluse app\PHPExcel$objReader = PHPExcel_IOFactory::createReader('Excel2007');
$objReader->setReadDataOnly(TRUE);
$objPHPExcel = $objReader->load("test.xlsx");
...
```php
/** PHPExcel */
use app\PHPExceluse app\PHPExceluse app\PHPExcelrequire_once 'PHPExcel.php';
