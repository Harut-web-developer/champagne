...
```php
use app\PHPExceluse app\PHPExcelPHPExcel_Settings::setZipClass(PHPExcel_Settings::PCLZIP);
```
*before* calling the save method of the Excel2007 Writer.

You can revert to using ZipArchive by calling:
```php
use app\PHPExceluse app\PHPExcelPHPExcel_Settings::setZipClass(PHPExcel_Settings::ZIPARCHIVE);
```
