...
use app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExceluse app\PHPExcelPHPExcel_Calculation::getInstance()->setCalculationCacheEnabled(FALSE);
...
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DATE'),
    array(2008, 12, 31)
);
// $retVal = 39813.0
...
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DATEDIF'),
    array($date1, $date2, 'd')
);
// $retVal = 2966
...
```php
use app\PHPExceluse app\PHPExcel$worksheet->setCellValue('A1', 'Date String');
...
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DATEVALUE'),
    array('31-Dec-2008')
);
// $retVal = 39813.0
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DAYOFMONTH'),
    array('25-Dec-2008')
);
// $retVal = 25
```
...
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DAYS360'),
    array($date1, $date2)
);
// $retVal = 1558
...
```php
use app\PHPExceluse app\PHPExcelPHPExcel_Calculation_Functions::setReturnDateType(
    PHPExcel_Calculation_Functions::RETURNDATE_EXCEL
);

$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'EDATE'),
...
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'EOMONTH'),
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'HOUROFDAY'),
    array('09:30')
);
// $retVal = 9
```
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'MINUTEOFHOUR'),
    array('09:30')
);
// $retVal = 30
```
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'MONTHOFYEAR'),
    array('14-July-2008')
);
// $retVal = 7
```
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'SECONDOFMINUTE'),
    array('09:30:17')
);
// $retVal = 17
```
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'DAYOFWEEK'),
    array('14-July-2008')
);
// $retVal = 7
```
...
```php
$retVal = call_user_func_array(
    array('app\PHPExcel-1.8_php8.1\PHPExcel-1.8\Classes\PHPExcel\Calculation\PHPExcel_Calculation_Functions', 'YEAR'),
    array('14-July-2001')
);
// $retVal = 2001
```
